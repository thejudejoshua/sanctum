		...
		<>
			<section className="hero flex flex-col justify-start items-start">
				...
				<div className="legal-section flex flex-col justify-start items-start">
					...
					<div className='legal-section-content flex flex-col'>
						<h2 className="h4">2. Use License</h2>
					...
					<div className='legal-section-content flex flex-col'>
						<h2 className="h4">3. Disclaimer</h2>
					...
					<div className='legal-section-content flex flex-col'>
						<h2 className="h4">4. Limitations</h2>
					...
					<div className='legal-section-content flex flex-col'>
						<h2 className="h4">5. Accuracy of Materials</h2>
					...
					<div className='legal-section-content flex flex-col'>
						<h2 className="h4">7. Modifications</h2>
					...
					<div className='legal-section-content flex flex-col'>
						<h2 className="h4">8. Governing Law</h2>
