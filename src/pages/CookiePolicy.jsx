		...
		<>
			...
			<section className="legal-section py-16 max-w-4xl mx-auto">
				<div className="space-y-8">
					<div>
						<h2 className="h2 mb-4">1. What Are Cookies?</h2>
					...
					<div>
						<h2 className="h2 mb-4">2. How We Use Cookies</h2>
						<p className="t-copy mb-4">Sanctum uses cookies for the following purposes:</p>
					...
					<div>
						<h2 className="h2 mb-4">3. Types of Cookies We Use</h2>
					...
					<div>
						<h2 className="h2 mb-4">4. Your Choices</h2>
					...
					<div>
						<h2 className="h2 mb-4">5. Third-Party Cookies</h2>
					...
					<div>
						<h2 className="h2 mb-4">6. Changes to This Cookie Policy</h2>
					...
					<div>
						<h2 className="h2 mb-4">7. Contact Us</h2>
